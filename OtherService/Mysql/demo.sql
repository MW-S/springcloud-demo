...
CREATE TABLE IF NOT EXISTS `product_index` (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1770990848249044995 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 正在导出表  demo.product_index 的数据：~0 rows (大约)
...
INSERT INTO `product_index` (`id`, `name`, `create_time`) VALUES
	...
	(1770979171784888321, 'ces32', '2024-03-22 01:01:52');
...
-- 正在导出表  demo.role_index 的数据：~2 rows (大约)
...
CREATE TABLE IF NOT EXISTS `role_permmission_index` (
  ...
  CONSTRAINT `FK_role_permmission_index_permmision_index` FOREIGN KEY (`permmission_id`) REFERENCES `permmision_index` (`id`),
  CONSTRAINT `FK_role_permmission_index_role_index` FOREIGN KEY (`role_id`) REFERENCES `role_index` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 正在导出表  demo.role_permmission_index 的数据：~8 rows (大约)
...
CREATE TABLE IF NOT EXISTS `user_index` (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1770848180722384898 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 正在导出表  demo.user_index 的数据：~4 rows (大约)
/*!40000 ALTER TABLE `user_index` DISABLE KEYS */;
INSERT INTO `user_index` (`id`, `username`, `password`, `create_time`) VALUES
	(1, 'adm_1', '$2a$10$mY2LJqcIuD5q2NUgvzdtNuY2kFsko7viG0Vf815oht6bKBZHnkgrS', '2024-03-19 19:26:43'),
	(2, 'editor_1', '$2a$10$mY2LJqcIuD5q2NUgvzdtNuY2kFsko7viG0Vf815oht6bKBZHnkgrS', '2024-03-19 19:26:43'),
	(3, 'user_1', '$2a$10$mY2LJqcIuD5q2NUgvzdtNuY2kFsko7viG0Vf815oht6bKBZHnkgrS', '2024-03-19 19:26:43'),
	(4, 'MW-S', '$2a$10$/K4whB9YhtfuDuQW0oVi7e5GNXPA7V4/n0brysxqxF/mMNNeFHCSK', '2024-03-21 08:01:37');
...
CREATE TABLE IF NOT EXISTS `user_role_index` (
  ...
  CONSTRAINT `FK_user_role_index_role_index` FOREIGN KEY (`role_id`) REFERENCES `role_index` (`id`),
  CONSTRAINT `FK_user_role_index_user_index` FOREIGN KEY (`user_id`) REFERENCES `user_index` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 正在导出表  demo.user_role_index 的数据：~2 rows (大约)
